        ...
        questions: [
            {
                ...
                ngmi: "Arc House is about the builders, not just the tickers. Focus on the community."
            },
            {
                question: "How does someone become an Architect in the program?",
                ...
                correct_answer: "By contributing and earning points through activity",
                ngmi: "You can't buy status here. You earn it through sweat equity and contribution."
            },
            {
                question: "What is the main purpose of the Architects Program?",
                ...
                correct_answer: "To grow and support the ecosystem through contributors",
                ngmi: "It's about sustainable growth, not just a one-time drop."
            },
            {
                question: "What do participants earn through their contributions?",
                options: ["Only tokens", "Only NFTs", "Points, reputation, and opportunities within the ecosystem", "Mining rewards"],
                correct_answer: "Points, reputation, and opportunities within the ecosystem",
                ngmi: "In the agentic economy, reputation is the ultimate currency."
            },
            {
                question: "What kind of activities can increase your Architect level?",
                options: ["Only trading", "Posting content, attending events, and helping the community", "Just holding tokens", "Running nodes only"],
                correct_answer: "Posting content, attending events, and helping the community",
                ngmi: "Passive holding isn't enough. Get active or get left behind."
            }
        ]
    },
    level2: {
        ...
        questions: [
            {
                question: "What is the main benefit of using USDC on Arc for banks?",
                options: ["Higher volatility", "Capital efficiency and faster settlement", "Increased transaction delays", "Manual reconciliation"],
                correct_answer: "Capital efficiency and faster settlement",
                ngmi: "Banks hate idle money. Speed is the game."
            },
            {
                question: "How does Arc improve capital efficiency for financial institutions?",
                ...
                correct_answer: "By enabling near-instant settlement and reducing idle capital",
                ngmi: "Instant settlement means your money works 24/7."
            },
            {
                question: "What role does USDC play in this system?",
                options: ["Governance token", "Mining reward", "Stable digital dollar for transactions and settlements", "NFT currency"],
                correct_answer: "Stable digital dollar for transactions and settlements",
                ngmi: "USDC is the fuel for stable institutional flow."
            },
            {
                question: "Why is instant settlement important for banks?",
                ...
                correct_answer: "It reduces liquidity needs and operational risk",
                ngmi: "Less time in transit means less risk of something breaking."
            },
            {
                question: "What makes Arc suitable for institutional adoption?",
                ...
                correct_answer: "Stablecoin-native design with reliable infrastructure",
                ngmi: "Institutions don't want memes; they want native stability."
            }
        ]
    },
    level3: {
        ...
        questions: [
            {
                question: "What is the main purpose of ERC-8183?",
                ...
                correct_answer: "To standardize job + payment workflows onchain",
                ngmi: "Standardization is what allows agents to 'talk' to each other's wallets."
            },
            {
                question: "Which of the following are the three main roles in the system?",
                options: ["Buyer, Seller, Miner", "User, Validator, Node", "Client, Provider, Evaluator", "Creator, Holder, Trader"],
                correct_answer: "Client, Provider, Evaluator",
                ngmi: "The Holy Trinity of Agentic Flow: Client, Provider, and the Evaluator who confirms it."
            },
            {
                question: "What happens to funds when a job is created?",
                options: ["Sent directly to provider", "Burned temporarily", "Locked in escrow until completion", "Split among validators"],
                correct_answer: "Locked in escrow until completion",
                ngmi: "Escrow ensures nobody gets rugged. Trustless execution 101."
            },
            {
                question: "What determines whether payment is released or refunded?",
                options: ["Gas fees", "Time alone", "Evaluator decision", "Network congestion"],
                correct_answer: "Evaluator decision",
                ngmi: "The Evaluator is the judge. No proof, no pay."
            },
            {
                question: "What makes this system suitable for AI agents as well?",
                ...
                correct_answer: "It supports automated verification and execution",
                ngmi: "Agents don't wait for clicks. They need automated verification."
            }
        ]
    },
    level4: {
        ...
        questions: [
            {
                ...
                correct_answer: "The moment quantum computers break current cryptography",
                ngmi: "Q-Day is the 'Boss Battle' for blockchain security."
            },
            {
                question: "Why are current blockchains vulnerable to Q-Day?",
                ...
                correct_answer: "Use of cryptographic algorithms that quantum computers can break",
                ngmi: "Modern math won't save you from quantum processing. We need new tech."
            },
            {
                question: "Which type of cryptography is considered safer against quantum attacks?",
                ...
                ngmi: "PQC is the only way forward. Everything else is toast."
            },
            {
                question: "What is a key challenge in upgrading blockchains for quantum resistance?",
                options: ["Lack of users", "Too many tokens", "Migrating existing wallets and keys securely", "Low transaction speed"],
                correct_answer: "Migrating existing wallets and keys securely",
                ngmi: "It's like heart surgery for the network. Migration is hard."
            },
            {
                question: "What is Arc's approach to Q-Day readiness?",
                ...
                correct_answer: "Design systems that can adapt to new cryptographic standards",
                ngmi: "Adaptability is survival. Arc is built to evolve."
            }
        ]
    },
    level5: {
        ...
        questions: [
            {
                question: "What is the main focus of Circle AI Skills?",
                options: ["Teaching blockchain mining", "Developing AI-related skills for the future economy", "Creating NFTs", "Trading strategies"],
                correct_answer: "Developing AI-related skills for the future economy",
                ngmi: "The future isn't just code; it's agentic AI skills."
            },
            {
                question: "Why are AI skills important in this ecosystem?",
                ...
                correct_answer: "To support agent-based economic systems and automation",
                ngmi: "If you don't know AI, you can't build for the Agentic Economy."
            },
            {
                question: "What type of economy is being emphasized?",
                options: ["Manual labor economy", "Token speculation economy", "Agentic and AI-driven digital economy", "Traditional banking only"],
                correct_answer: "Agentic and AI-driven digital economy",
                ngmi: "We are moving past human-only labor to agent-driven scale."
            },
            {
                ...
                correct_answer: "By building, contributing, and accessing new opportunities",
                ngmi: "Skill up or stay behind. Builders get the opportunities."
            },
            {
                question: "What is the long-term vision of combining AI and blockchain?",
                ...
                correct_answer: "Enable autonomous, scalable economic interactions",
                ngmi: "Blockchain provides the trust; AI provides the scale. It's the ultimate combo."
            }
        ]
    }
};
...
function renderDashboard() {
    ...
    Object.keys(DB).forEach((key, index) => {
        ...
        const level = DB[key];
        const isLocked = levelNum > state.unlockedLevels;
        ...
        card.innerHTML = `
            ...
            <div class="card-actions">
                <a href="${level.docLink}" target="_blank" class="doc-btn" onclick="state.visitedDocs.add('${key}'); renderDashboard();">DOCS</a>
                <button class="start-btn" onclick="startQuiz('${key}')" ${isLocked || !state.visitedDocs.has(key) ? 'disabled' : ''}>
...
function showResults() {
    ...
    if(percent === 100) {
        ...
        msg.innerText = "Proof of knowledge recorded on the Arc Network.";
        ...
        verdict.innerText = "STATUS: NGMI";
        msg.innerText = "Accuracy is paramount for an Architect. Review the docs and try again.";
